...
import { MoneyMovementAddBatchPageForm } from './MoneyMovementAddBatchPageForm';
...
function MoneyMovementsLanding() {
    return <Switch>
        ...
        <Route exact path={`${FINANCE_BASE_URL}/money-movements/add/batch`} component={MoneyMovementAddBatchPageForm} />
